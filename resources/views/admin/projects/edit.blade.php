                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" placeholder="e.g. E-commerce Platform"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        id="title" name="title" placeholder="e.g. Online Store Management"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                        id="slug" name="slug" placeholder="e.g. ecommerce-platform"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <img id="imagePreview"
                                            src="{{ $project->image ? asset($project->image) : 'https://placehold.co/150x150?text=Preview' }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="status" class="form-select @error('status') is-invalid @enderror"
                                        ...
                                        <option value="1"
                                            {{ old('status', $project->status) == 1 ? 'selected' : '' }}>Active</option>
                                        <option value="0"
                                            {{ old('status', $project->status) == 0 ? 'selected' : '' }}>Inactive</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
