    ...
    <div class="container-fluid">
        <div class="page-title-head d-flex align-items-center">
            <div class="flex-grow-1">
                <h4 class="page-main-title m-0">Edit Team Member</h4>
            </div>
            <div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" placeholder="e.g. John Doe"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('position') is-invalid @enderror"
                                        id="position" name="position" placeholder="e.g. Lead Developer"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        id="email" name="email" placeholder="e.g. john@example.com"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mt-3">
                                        <img id="imagePreview"
                                            src="{{ $team->image ? asset($team->image) : 'https://placehold.co/150x150?text=Preview' }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="url" class="form-control @error('fb_link') is-invalid @enderror"
                                        id="fb_link" name="fb_link" placeholder="https://facebook.com/..."
                                        value="{{ old('fb_link', $team->fb_link) }}" />
                                    @error('fb_link')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="url" class="form-control @error('twitter_link') is-invalid @enderror"
                                        id="twitter_link" name="twitter_link" placeholder="https://twitter.com/..."
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="url" class="form-control @error('linkedin_link') is-invalid @enderror"
                                        id="linkedin_link" name="linkedin_link" placeholder="https://linkedin.com/in/..."
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="url" class="form-control @error('insta_link') is-invalid @enderror"
                                        id="insta_link" name="insta_link" placeholder="https://instagram.com/..."
                                        value="{{ old('insta_link', $team->insta_link) }}" />
                                    @error('insta_link')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea id="bio" name="bio"
                                        class="form-control ckeditor @error('bio') is-invalid @enderror" rows="4"
                                        placeholder="Member biography...">{{ old('bio', $team->bio) }}</textarea>
                                    @error('bio')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row g-3 mt-4">
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ti ti-check me-2"></i>Update Team Member
                                    </button>
                                    <a href="{{ route('admin.teams.index') }}" class="btn btn-light">
